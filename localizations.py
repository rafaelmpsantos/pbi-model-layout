...
TRANSLATIONS = {
    "en": {
        ...
        "power_query_title": "Power Query and table sources",
        "power_query_summary": "Partitions: {count}",
        "power_query_empty": "No table partition/query details were found in the model.",
        "partition_column": "Partition",
        "source_type_column": "Source type",
        "expression_column": "Expression",
        "expression_steps_column": "Steps",
    ...
    "pt": {
        ...
        "power_query_title": "Power Query e fontes das tabelas",
        "power_query_summary": "Partições: {count}",
        "power_query_empty": "Nenhum detalhe de partição/query foi encontrado no modelo.",
        "partition_column": "Partição",
        "source_type_column": "Tipo da origem",
        "expression_column": "Expressão",
        "expression_steps_column": "Etapas",
